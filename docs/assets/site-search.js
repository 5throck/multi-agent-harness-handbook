...
(function () {
  ...
  var DOCS = [
    ...
    { path: 'tools/07_Tools_Manual.html', title: '7장 · 도구 비교 — Claude Code / Claude App / Antigravity CLI / Antigravity' },
    { path: 'enterprise/08_Enterprise_Chapter.html', title: '8장 · 기업 내부 멀티 에이전트팀 운영, 두 가지 모델 비교' },
    { path: 'workflows/09_Workflows_Chapter.html', title: '9장 · 워크플로우 디자인 패턴' },
    { path: 'intro/10_Intro_Advanced_Deploy.html', title: '10장 §1 · 배포와 SSOT' },
    { path: 'intro/10_Intro_Advanced_Chapter.html', title: '10장 §2 · 생애주기 관리' },
    { path: 'intro/10_Intro_Advanced_AGENTS.html', title: '10장 §3 · AGENTS.md 심화' },
    { path: 'intro/10_Intro_Advanced_Architecture.html', title: '10장 §4 · 아키텍처 심화' },
    { path: 'variant-advanced/11_VariantAdvanced_Chapter.html', title: '11장 §1 · 새 variant 만들기 vs 기존 프로젝트를 variant로 승격하기' },
    { path: 'variant-advanced/12_VariantAdvanced_Examples.html', title: '12장 · 새 variant vs 신규 variant 승격 실습 예시 — 시나리오별 학습 가이드' },
