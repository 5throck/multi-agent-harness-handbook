...
(function () {
  ...
  var DOCS = [
    ...
    { path: 'variant-advanced/10_VariantAdvanced_Chapter.html', title: '10장 · 새 variant 만들기 vs 기존 프로젝트를 variant로 승격하기' },
    { path: 'variant-advanced/11_VariantAdvanced_Examples.html', title: '11장 · 새 variant vs 신규 variant 승격 실습 예시 — 시나리오별 학습 가이드' },
    { path: 'capstone/12_Capstone.html', title: '12장 · 캡스톤 실습 — 나만의 워크플로우 설계하기' },
