...
(function () {
  ...
  var DOCS = [
    ...
    { path: 'intro/10_ProjectUpgrade_Chapter.html', title: '10장 · L3 프로젝트 업그레이드', lang: 'ko' },
    ...
    { path: 'intro/10_ProjectUpgrade_Chapter_en.html', title: 'Chapter 10 - L3 Project Upgrade', lang: 'en' },
    ...
    { path: 'tools/00_Tools_Manual_en.html', title: 'Tool Comparison — Claude Code / Claude Desktop App / Antigravity CLI / Antigravity', lang: 'en' },
    ...
    { path: 'intro/10_ProjectUpgrade_Chapter_ja.html', title: '第10章・L3プロジェクトのアップグレード', lang: 'ja' },
    ...
    { path: 'tools/00_Tools_Manual_ja.html', title: 'ツール比較 — Claude Code / Claude Desktop App / Antigravity CLI / Antigravity', lang: 'ja' },
    ...
    { path: 'tools/00_Tools_Manual_es.html', title: 'Comparación de Herramientas — Claude Code / Claude Desktop App / Antigravity CLI / Antigravity', lang: 'es' },
