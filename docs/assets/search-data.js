...
var SEARCH_DATA = {
  DOCS: [
    ...
    { path: 'practice/04_Practice_Manual_C.html', title: '4장 §1-C · 서브에이전트 활용 상세 — Codex 중심', lang: 'ko' },
    ...
    { path: 'practice/04_Practice_Examples_C.html', title: '4장 §2-C · 멀티 에이전트 팀 실습 — Codex 중심 시나리오별 학습 가이드', lang: 'ko' },
    ...
    { path: 'domain-model/13_DomainOperatingModel_Chapter.html', title: '13장 · Domain Operating Model — 템플릿이 실행 가능한 SOP가 되는 법', lang: 'ko' },
    { path: 'capstone/14_Capstone.html', title: '14장 · 캡스톤 실습 — 나만의 워크플로우 설계하기', lang: 'ko' },
    ...
    { path: 'practice/04_Practice_Manual_C_en.html', title: 'Chapter 4 §1-C · Subagent Usage in Detail — Codex Focus', lang: 'en' },
    ...
    { path: 'practice/04_Practice_Examples_C_en.html', title: 'Chapter 4 §2-C · Multi-Agent Team Practice — A Codex-Focused Scenario-Based Learning Guide', lang: 'en' },
    ...
    { path: 'domain-model/13_DomainOperatingModel_Chapter_en.html', title: 'Chapter 13 · Domain Operating Model — How Templates Become Executable SOPs', lang: 'en' },
    { path: 'capstone/14_Capstone_en.html', title: 'Chapter 14 · Capstone Exercise — Designing Your Own Workflow', lang: 'en' },
    ...
    { path: 'practice/04_Practice_Manual_C_ja.html', title: '第4章 §1-C・サブエージェント活用詳細 — Codex中心', lang: 'ja' },
    ...
    { path: 'practice/04_Practice_Examples_C_ja.html', title: '第4章 §2-C・マルチエージェントチーム実習 — Codex中心シナリオ別学習ガイド', lang: 'ja' },
    ...
    { path: 'domain-model/13_DomainOperatingModel_Chapter_ja.html', title: '第13章・Domain Operating Model — テンプレートが実行可能なSOPになるしくみ', lang: 'ja' },
    { path: 'capstone/14_Capstone_ja.html', title: '第14章・キャップストーン演習 — 自分だけのワークフローを設計する', lang: 'ja' },
    ...
    { path: 'practice/04_Practice_Manual_C_es.html', title: 'Capítulo 4 §1-C · Uso Detallado de Subagentes — Enfoque en Codex', lang: 'es' },
    ...
    { path: 'practice/04_Practice_Examples_C_es.html', title: 'Capítulo 4 §2-C · Práctica de Equipos Multiagente — Guía de Aprendizaje por Escenarios con Codex', lang: 'es' },
    ...
    { path: 'domain-model/13_DomainOperatingModel_Chapter_es.html', title: 'Capítulo 13 · Domain Operating Model — Cómo las Plantillas se Convierten en SOP Ejecutables', lang: 'es' },
    { path: 'capstone/14_Capstone_es.html', title: 'Capítulo 14 · Proyecto Final — Diseñar Tu Propio Flujo de Trabajo', lang: 'es' },
